...
namespace ToktersPlayground.Components.System.Commands
{
    ...
    {
        private FilePickerSaveOptions _saveOptions;

        public SaveProject()
        {
            _saveOptions = new FilePickerSaveOptions();
            _saveOptions.Title = "Save Playground Project";
            _saveOptions.DefaultExtension = "playground";

            var fileTypes = new List<FilePickerFileType>();
            fileTypes.Add(new FilePickerFileType("Playground File") { Patterns = new[] { "*.playground" } });
